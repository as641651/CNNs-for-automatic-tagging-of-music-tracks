...
function cnn_6()
   ...
   local net = nn.Sequential()
   net:add(nn.SpatialConvolutionMM(256,256,3,3,1,1))
...
function net.forward(input)
     ...
     assert(input:size(3) == 192, "Suports only 96 feat len" )
...
--     print("cnn_5 size ", net.cache.cnn_5:size())
     net.cache.cnn_6 = net.model:get(2):get(6):forward(net.cache.cnn_5)
--     print("cnn_6 size ", net.cache.cnn_6:size())

     local cnn_output = net.cache.cnn_6:view(net.cache.cnn_6:size(1),-1)
--     print(cnn_output)
--     os.exit()
...
function net.backward(input, gradOutput)
  ...
  gradOutput = gradOutput:view(net.cache.cnn_6:size())
--  print("grad cnn_6 size ", gradOutput:size())
  net.cache.grad_cnn_5 = net.model:get(2):get(6):backward(net.cache.cnn_5,gradOutput)
--  print("grad cnn_5 size ", net.cache.grad_cnn_5:size())
  net.cache.grad_cnn_4 = net.model:get(2):get(5):backward(net.cache.cnn_4,net.cache.grad_cnn_5)
--  print("grad cnn_4 size ", net.cache.grad_cnn_4:size())
  net.cache.grad_cnn_3 = net.model:get(2):get(4):backward(net.cache.cnn_3,net.cache.grad_cnn_4)
--  print("grad cnn_3 size ", net.cache.grad_cnn_3:size())
  net.cache.grad_cnn_2 = net.model:get(2):get(3):backward(net.cache.cnn_2,net.cache.grad_cnn_3)
--  print("grad cnn_2 size ", net.cache.grad_cnn_2:size())
  net.cache.grad_cnn_1 = net.model:get(2):get(2):backward(net.cache.cnn_1,net.cache.grad_cnn_2)
--  print("grad cnn_1 size ", net.cache.grad_cnn_1:size())
